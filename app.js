...
// newShift = {
//     clientLocation : "1 Applewood Drive",
//     firstName : "Todd",
//     lastName : "Lawson-Cook",
//     startTime : "16:00:00",
//     endTime : "20:30:00",
//     shiftDate : "2022-11-27",
//     hoursWorked : 4.5,
// }
...
const addShift = async (shift)=>{
    try{
        ...
        console.log(`staff id : ${staff_id[0].id}`)

        const queryString = `INSERT INTO shifts (start_time, end_time, shift_date, staff_id, client_id, hours_worked)
        VALUES ('${shift.startTime}',
        '${shift.endTime}',
        '${shift.shiftDate}',
        '${staff_id[0].id}',
        '${client_id[0].id}',
...
const listShifts = async (shift_date) =>{
    ...
    //    `SELECT CONCAT (staff.first_name," ", staff.last_name) AS staff_name, start_time,end_time, shift_date, hours_worked,
    //    CONCAT (clients.first_name, ' ', clients.last_name) as client_name, client_location
    //    FROM staff
    //    JOIN shifts
    //    ON staff.id = shifts.staff_id 
